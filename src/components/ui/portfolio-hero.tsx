                            ...
                            >
                                {menuItems.map((item) => (
                                    <a
                                        ...
                                        style={{
                                            color: item.highlight ? "#00FF88" : isDark ? "hsl(0 0% 100%)" : "hsl(0 0% 10%)",
                                        }}
                                        onMouseEnter={(e) => {
                                            e.currentTarget.style.color = "#00FF88";
                                        }}
                                        onMouseLeave={(e) => {
                                            e.currentTarget.style.color = item.highlight ? "#00FF88" : (isDark ? "hsl(0 0% 100%)" : "hsl(0 0% 10%)");
                                        }}
            ...
            <main className="relative min-h-screen flex flex-col">
                    ...
                    <div className="relative text-center">
                        <div className="flex flex-col items-center">
                            ...
                            <BlurText
                                ...
                                animateBy="letters"
                                direction="top"
                                className="font-bold text-[32px] sm:text-[40px] md:text-[50px] lg:text-[60px] leading-[0.75] tracking-tighter uppercase justify-center whitespace-nowrap mt-4"
                                style={{ color: "#00FF88", fontFamily: "'Space Grotesk', sans-serif" }}
                            />
                        </div>
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-none">
                            <div className="w-[120px] h-[120px] sm:w-[150px] sm:h-[150px] md:w-[180px] md:h-[180px] lg:w-[200px] lg:h-[200px] rounded-full overflow-hidden shadow-2xl transition-transform duration-300 hover:scale-110 cursor-pointer pointer-events-auto border-4 border-industrial-green/50">
                                <img
                                    src="https://i.postimg.cc/sXtG0bqP/profile.png"
                                    alt="Profile"
                ...
                <div className="absolute bottom-16 sm:bottom-20 md:bottom-24 lg:bottom-32 xl:bottom-36 left-1/2 -translate-x-1/2 w-full px-6">
                    <div className="flex justify-center">
                        <BlurText
                            text="Designing Systems To Scale Businesses."
                            delay={150}
                            animateBy="words"
                            direction="top"
                            className="text-[15px] sm:text-[18px] md:text-[20px] lg:text-[22px] text-center transition-colors duration-300 text-neutral-500 hover:text-industrial-green dark:hover:text-industrial-green"
                ...
                >
                    <ChevronDown className="w-5 h-5 md:w-8 md:h-8 text-neutral-500 hover:text-industrial-green transition-colors duration-300" />
                </a>
            </main>
        </div>
    );
